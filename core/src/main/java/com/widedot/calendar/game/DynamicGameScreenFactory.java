...
import com.widedot.calendar.screens.CrystalizeGuessGameScreen;
...
class GameScreenRegistry {
    ...
    static {
        ...
        registry.put("crystalizeGuess", (dayId, game, theme, parameters) -> new CrystalizeGuessGameScreen(dayId, game, theme, parameters));
